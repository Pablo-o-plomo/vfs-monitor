...
const STAGE_LABELS = {
  ...
  login:                  'Авторизация',
  login_manual_required:  '⚠️ Требуется ручной вход',
  selecting_country:      'Выбрана страна',
  selecting_center:       'Выбран центр',
  selecting_category:     'Выбрана категория',
  checking_slots:         'Переходим к записи',
  calendar_waiting:       'Ожидает загрузку календаря',
  calendar_open:          'Календарь открыт',
  searching_dates:        'Ищет доступные даты',
  slot_found:             'Найден слот',
  no_slots:               'Доступных дат нет',
  banner_out_of_range:    'Ближайший слот вне диапазона',
  banner_error:           'Ошибка разбора даты',
  slot_in_range:          'Слот входит в диапазон',
  filling_applicant:      'Заполняет данные заявителя',
  selecting_time:         'Выбирает время',
  confirming:             'Подтверждает запись',
  booked:                 'Запись оформлена',
  booking_failed:         'Ошибка бронирования',
  done:                   'Проверка завершена',
  screenshot:             'Скриншот сохранён',
  url_info:               'URL страницы',
  page_info:              'Заголовок страницы',
